  ...
  switch (action.type) {
    ...
    case ALL_PRODUCT_SUCEESS:
      return {
        ...state,
        loading: false,
        products: action.payload.data || ["asw"],
        productsCount: action.payload.count || 0,
        resultPerPage: action.payload.resultPerPage || 0,
        filteredProductsCount: action.payload.filteredProductsCount || 0,
      };
...
export const rekomendasiProductReducer = (
  state = { rekomendasiProduct: [] },
  action
) => {
    // console.log(action)
  switch (action.type) {
    case REKOMENDASI_PRODUCT_REQUEST:
      return {
        loading: true,
        rekomendasiProduct: [],
      };
    case REKOMENDASI_PRODUCT_SUCCESS:
      return {
        loading: false,
        rekomendasiProduct: action.payload.products,
      };
    case REKOMENDASI_PRODUCT_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
